...
public static ResponseSpecification responseSpec;	
	...
	public void Assert200(Hashtable<String,String> dataTable) {
		...
		given().header("Authorization",auth.ValidAuth).param("PoolID",dataTable.get("PoolID")).when().get(dataTable.get("EndPoint")).
	...
	public void Assert401(Hashtable<String,String> dataTable)
	{
		...
		given().header("Authorization",auth.InvalidAuth).param("PoolID",dataTable.get("PoolID")).when().get(dataTable.get("EndPoint")).
