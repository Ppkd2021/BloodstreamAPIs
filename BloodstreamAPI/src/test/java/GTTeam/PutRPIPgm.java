...
public class PutRPIPgm extends Suite{ 
public static ResponseSpecification responseSpec;

	@Test(dataProviderClass = DataHandler.class,dataProvider="dataProvider")
	public void Assert200(Hashtable<String,String> dataTable) {

			File file = new File(System.getProperty("user.dir")+"//payloads//PutRPIPgm200.json");
		...
		public void Assert409(Hashtable<String,String> dataTable) {
		 ...
		 File file = new File(System.getProperty("user.dir")+"//payloads//PutRPIPgm409.json");
		...
		public void Assert400(Hashtable<String,String> dataTable) {
				...
				File file = new File(System.getProperty("user.dir")+"//payloads//PutRPIPgm400.json");
