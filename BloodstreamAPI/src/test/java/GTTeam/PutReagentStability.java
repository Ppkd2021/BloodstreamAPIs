...
public class PutReagentStability extends Suite{ 
...
public void Assert200(Hashtable<String,String> dataTable) {
		...
		File file = new File(System.getProperty("user.dir")+"//payloads//PUTReagentStability200.json");
	...
	public void Assert409(Hashtable<String,String> dataTable) {
	 ...
	 File file = new File(System.getProperty("user.dir")+"//payloads//PUTReagentStability409.json");
	...
	public void Assert400(Hashtable<String,String> dataTable) {
			...
			File file = new File(System.getProperty("user.dir")+"//payloads//PUTReagentStability400.json");
