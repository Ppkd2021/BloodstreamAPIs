...
public class putArchivedSampleGridLayout extends Suite{
	public static ResponseSpecification responseSpec;	
	  ...
	  @Test(dataProviderClass = DataHandler.class,dataProvider="dataProvider")
		public void Assert200(Hashtable<String,String> dataTable) {
		  ...
		  File file = new File(System.getProperty("user.dir")+"//payloads//putArchivedSampleGridLayout200.json");
		...
		public void Assert400(Hashtable<String,String> dataTable){
		 ...
		 File file = new File(System.getProperty("user.dir")+"//payloads//putArchivedSampleGridLayout400.json");
		 given().header("Authorization",auth.ValidAuth).body(file).
